...
<nav class="navbar navbar-default navbar-fixed-top appsLand-navbar active-navbar">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo bloginfo('home');?>/">
                <img alt="<?php echo bloginfo('home');?>/" src="<?php echo $logo = ot_get_option('logo');?>">
                <h2>ASTRA<br>
                    
<span class="set-align">The Social Supercomputer</span></h2>
            </a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right appsLand-links">
                <li class="visible-xs-block text-center mobile-size-logo">
                    <a href="<?php echo bloginfo('home');?>/">
                        <img alt="" src="<?php echo $logo = ot_get_option('logo');?>">
                          <h2>ASTRA<br>
                            
<span class="set-align">The Social Supercomputer</span></h2>
                    </a>
                </li>
                <li><a href="https://demo-octalogo.com/astraa-wp/">Home</a></li>
                 <li><a href="https://demo-octalogo.com/astraa-wp/token/">Token</a></li>
               <li>
                        <a href="<?php echo bloginfo('template_url');?>/assests/Astra-Introduction.pdf">Presentation</a>
                        
                    </li>
                <li><a href="http://goastra.network/assets/Astra-Whitepaper.pdf">Whitepaper</a></li>
                <!-- <li><a href="#download">One-Pager</a></li> -->
                <li><a href="http://goastra.network/assets/Astra-FAQ.pdf" target="_blank">FAQ</a></li>
                <li><a href="https://demo-octalogo.com/astraa-wp/#team">Team</a></li>
                <li><a href="https://demo-octalogo.com/astraa-wp/#media">Media</a></li>
                <li><a href="https://demo-octalogo.com/astraa-wp/roadmap/">Roadmap</a></li>
                <li class="roundedcrck"><a href="https://t.me/Astra_Network"><i aria-hidden="true" class="fa fa-location-arrow"></i> Join Telegram</a></li>
